...
import { useSurebet6Way } from "@/app/hooks/useSurebet6Way";
...
import { CalculatorState6Way } from "@/app/page";

interface SureBetCalculator6WayProps {
    initialParams?: Record<string, string>;
    calculatorState: CalculatorState6Way;
    setCalculatorState: React.Dispatch<React.SetStateAction<CalculatorState6Way>>;
    resetCalculatorState: () => void;
}

const SureBetCalculator6Way: React.FC<SureBetCalculator6WayProps> = ({
    initialParams,
    calculatorState,
    setCalculatorState,
    ...
    const {
        ...
        odds1Type, odds2Type, odds3Type, odds4Type, odds5Type, odds6Type,
        totalStake,
    ...
    const setFixedField = (value: StakeField6Way) => setCalculatorState(prev => ({ ...prev, fixedField: value }));
    ...
    useEffect(() => {
        ...
        if (initialParams.stake1 || initialParams.stake2 || initialParams.stake3 || initialParams.stake4 || initialParams.stake5 || initialParams.stake6) {
            newState.fixedField = initialParams.stake1 ? 'stake1' : initialParams.stake2 ? 'stake2' : initialParams.stake3 ? 'stake3' : initialParams.stake4 ? 'stake4' : initialParams.stake5 ? 'stake5' : 'stake6';
    ...
    const { stake1: calcStake1, stake2: calcStake2, stake3: calcStake3, stake4: calcStake4, stake5: calcStake5, stake6: calcStake6, totalStake: calcTotalStake, profit, profitPercentage } = useSurebet6Way({
        odds1, odds2, odds3, odds4, odds5, odds6,
        totalStake,
        stake1, stake2, stake3, stake4, stake5, stake6,
        fixedField,
    ...
    return (
        <Card className="w-full max-w-md mx-auto">
            <CalculatorHeader title="6-Way Calculator" value={profitPercentage} onReset={resetCalculatorState} />
            <CardContent className="relative grid gap-4 pt-4">
                <OddsStakeRow<StakeField6Way>
                    ...
                    oddsId="odds1-6way" stakeId="stake1-6way"
                ...
                <OddsStakeRow<StakeField6Way>
                    ...
                    oddsId="odds2-6way" stakeId="stake2-6way"
                    fixedField={fixedField} setFixedField={setFixedField}
                ...
                <OddsStakeRow<StakeField6Way>
                    ...
                    oddsId="odds3-6way" stakeId="stake3-6way"
                    fixedField={fixedField} setFixedField={setFixedField}
                ...
                <OddsStakeRow<StakeField6Way>
                    ...
                    oddsId="odds4-6way" stakeId="stake4-6way"
                    fixedField={fixedField} setFixedField={setFixedField}
                ...
                <OddsStakeRow<StakeField6Way>
                    ...
                    oddsId="odds5-6way" stakeId="stake5-6way"
                    fixedField={fixedField} setFixedField={setFixedField}
                    stakeFieldName="stake5"
                />
                <OddsStakeRow<StakeField6Way>
                    oddsType={odds6Type} setOddsType={setOdds6Type}
                    odds={odds6} setOdds={setOdds6}
                    stake={calcStake6} setStake={setStake6}
                    labelOdds="Odds 6" labelStake="Stake 6"
                    oddsId="odds6-6way" stakeId="stake6-6way"
                    fixedField={fixedField} setFixedField={setFixedField}
                    stakeFieldName="stake6"
                />
                <TotalStakeRow
                ...
                <BetSaveSection
                    betFields={{
                        odds1, odds2, odds3, odds4, odds5, odds6,
                        odds1Type, odds2Type, odds3Type, odds4Type, odds5Type, odds6Type,
                        stake1: calcStake1, stake2: calcStake2, stake3: calcStake3, stake4: calcStake4, stake5: calcStake5, stake6: calcStake6,
                        totalStake: calcTotalStake,
                        fixedField
                    }}
                    betName={name} setBetName={setName}
                    storageKey="savedBets6Way"
...
export default SureBetCalculator6Way;
